...
;; nbb/SCI does not support deftype; use defrecord instead.
;; IIndexed is omitted since all internal access goes through
;; the root/children accessor functions below.
(defrecord RoseTree [root children])
